...
def get_config() -> ForecastConfig:
    ...
    config.sarimax_params_file = "results/tuning/sarimax_best_params_20260311_213835.json" #TODO
    config.xgb_params_file = "results/tuning/xgboost_best_params_20260309_081759.json" #TODO
